...
// int sprd_register_enable_irq_wake = 1;
void sprd_register_enable_irq_wake(void) {
	printk("MEUI:sprd_register_enable_irq_wake\n");
}
// int sprd_unregister_disable_irq_wake = 2;
void sprd_unregister_disable_irq_wake(void) {
	printk("MEUI:sprd_unregister_disable_irq_wake\n");
}
